...
# Handle database URL appropriately based on the type
database_url = settings.DATABASE_URL

# Only apply PostgreSQL-specific transformations if it's a PostgreSQL URL
if database_url.startswith("postgresql://"):
    ...
    # For SQLite and other databases, use default connect_args
    connect_args = {}
